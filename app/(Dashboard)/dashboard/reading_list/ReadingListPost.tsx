...
import Icon from '@/app/(MindWriters)/(MainSite)/component/Icon';

export default function ReadingListPost({ post }) {

    return (

        <div className='w-full mb-3  border-green-900 rounded-md shadow-md  bg-gray-50 text-gray-800'>
            <div className='flex items-center justify-between p-3'>
                <div className='flex items-center space-x-2'>
                    ...
                    <div className={'p-2 '}>
                        <div className='text-sm font-semibold leadi'>{post.user.name}</div>
            ...
            <div className={'relative'}>
                ...
                <div className={'absolute right-6 top-3'}>
                    <Icon post_id={post._id} />
                </div>

            </div>

            <div className='pl-2 mt-6 flex flex-col justify-start items-start '>
                <div className='text-black font-extrabold text-xl'>{post.topic.name}</div>

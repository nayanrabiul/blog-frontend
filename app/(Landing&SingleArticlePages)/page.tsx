import '@/globals.css';
import HomePageRecentPost from '@/app/(Landing&SingleArticlePages)/component/HomePageRecentPost';
            ...
            <section className='text-gray-800'>
                <div className='space-y-6 sm:space-y-12'>
                    ...
                    <div className='sm:pr-3'>
                        {
                            articles.length === 0 ? (
                                <div className='text-center w-max text-2xl font-bold text-gray-800'>
                                    No articles found
                                </div>
                            )
                        :
                            articles.map((article) => (
                                <HomePageRecentPost key={article._id} article={article} />
                            ))
                        }
                    </div>
                </div>
